...
import ImageLogo from '../../assets/images/reboque.png';
...
export default function SignIn({navigation}) {
  ...
  return (
    <View style={style.container}>
      ...
      <Text style={{color: '#E1E1E6', fontSize: 20, marginBottom: 12}}>
        Acesse sua conta
      </Text>
      ...
      <TouchableOpacity style={style.btnLogin} onPress={() => HandleSignIn()}>
